...
import com.example.lesson6lab.databinding.FragmentTryAgainBinding
 ...
 * Use the [TryAgainFragment.newInstance] factory method to
...
class TryAgainFragment : Fragment() {
    ...
    fun navigate(view: View) {
        view.findNavController().navigate(R.id.action_tryAgainFragment_to_quizFragment)
    }
